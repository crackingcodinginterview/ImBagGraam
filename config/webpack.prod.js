    ...
    module: {
      ...
      rules: [
         ...
         */
        {
          ...
          exclude: [/ngx-perfect-scrollbar/, /@swimlane/]
        },
        ...
        /*
         * Somehow the ngx-perfect-scrollbar doesn't play well with ExtractTextPlugin so we ignore it from ExtractTextPlugin
         * https://github.com/AngularClass/angular2-webpack-starter/issues/1541
         */
        {
          test: /\.css$/,
          use: ['to-string-loader', 'css-loader'],
          include: [/ngx-perfect-scrollbar/, /@swimlane/]
        },
        {
          test: /\.scss$/,
